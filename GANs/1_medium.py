...
os.makedirs("model_medium", exist_ok=True)
...
for epoch in range(epochs):
    ...
    if epoch % 2 == 0:
        ...
        plt.savefig(f"results_medium/generated_image_epoch_{epoch}.png")
        plt.close()  # Cerrar la figura para liberar memoria


# Guardar el modelo del Generador después del entrenamiento
torch.save(G.state_dict(), "model_medium/generator.pth")
# Guardar el Discriminador:
torch.save(D.state_dict(), "model_medium/discriminator.pth")
