    ...
    for epoch in range(epochs):
        ...
        if epoch % 10 == 0:
            ...
            for j in range(10):
                ...
                plt.savefig(f"tmp_results/CGAN/epoch_{epoch}_num_{sample_labels[j]}.png")
                plt.close()

    # Guardar los modelos:
    torch.save(G.state_dict(), "trained_models/CGAN/generator.pth")
    torch.save(D.state_dict(), "trained_models/CGAN/discriminator.pth")
